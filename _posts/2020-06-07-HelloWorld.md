...
date: 2020-06-07T15:02:00Z -0300
...
\begin{align}
a*{1} &= 15 &&&&& a*{15} &= a*1 + 14\cdot r\\\\
r&= 5 &&&&& a*{15} &= 15 + 14\cdot 5\\\\
a*{15} &= \\,\ ? &&&&& a*{15} &= 15 + 70\\\\
S*{15} &= \\,\ ? &&&&& a*{15} &= 85\\\\ \\\\
& &&&&& S*{15} &=\dfrac{(a_1 + a*{15})}{2} \cdot 15\\\\
& &&&&& S*{15} &=\dfrac{(15 + 85)}{2} \cdot 15\\\\
& &&&&& S*{15} &=\dfrac{100}{2} \cdot 15\\\\
& &&&&& S\_{15} &=750\\\\
\end{align}
